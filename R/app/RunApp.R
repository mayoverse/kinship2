...

{
  ...
  packages <- c("shiny", "ggplot2", "kinship2", "stringr", "plyr",
                "plotly", "DT", "shinyjs", "shinyWidgets", "tidyr", "readxl",
                "cowplot", "gridExtra", "gridGraphics", "shinycssloaders",
                "LIM")
