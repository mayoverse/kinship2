...
#'
#' [kinship()]: Calculates the kinship matrix, the probability
#' having an allele sampled from two individuals be the same via IBD.
#'
#' [ped_to_plotdf()] and [plot_fromdf()]: Plot method for a pedigree object.
...
#'
#' [bit_size()]: Approximate the output from SAS's `PROC FREQ`
