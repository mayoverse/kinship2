...
besthint <- function(ped, wt = c(1000, 10, 1), tolerance = 0) {
    ...
    # Put the subsets into a random order For most pedigrees, there are several
    # permutations that will give a tolerance or near tolerance plot. This way
    # we should hit one of them soon.
