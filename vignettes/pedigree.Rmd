...
This document is a tutorial for the `kinship2 package`, with examples of creating pedigree objects and kinship matrices
...
column in the *ped_df* dataframe. When this is the case, the family column will be
...
If we use the pedigree 2 from earlier and add a new spouse relationship between the individuals
