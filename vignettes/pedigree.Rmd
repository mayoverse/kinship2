...
fixped2 <- with(datped2, fix_parents(id, father, mother, sex))
fixped2
...
specify monozygosity for subjects 206 and 207 in samplepedigree 2, and subjects 125 and 126 in pedigree 1. We check it by looking at the kinship matrix for these pairs, which are correctly at $0.5$.
