...
- The [Pedigree() constructor]("pedigree_constructor.html") used to plot the pedigree `vignette("Pedigree() constructor", package = "Pedixplorer")`
- The [alignment algorithm]("alignement_details.html") used to plot the pedigree `vignette("Pedigree alignement details", package = "Pedixplorer")`
