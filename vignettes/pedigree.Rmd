...
-   The **$Pedigree$ object** `vignette("pedigree_object", package = "Pedixplorer")`
-   The **alignment algorithm** used create the Pedigree structure
    `vignette("alignment_details", package = "Pedixplorer")`
-   The **kinship algorithm** `vignette("kinship_details", package = "Pedixplorer")`
-   The **plotting algorithm** used to plot the Pedigree
    `vignette("pedigree_plot_details", package = "Pedixplorer")`
