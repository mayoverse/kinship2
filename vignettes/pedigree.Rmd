...
This document is a tutorial for the `Pedigree package`, with examples of
creating pedigree objects and kinship matrices and other pedigree utilities.

The `Pedigree package` contains the outines to handle family data with a
pedigree object.
...
Installation
===============
The `Pedigree package` is available on Bioconductor and can be installed
...
## Example Data
Two datasets are provided within the Pedigree package: 
...
calculations on them. The Pedigree package contains some routines to 
...
An additional function in Pedigree is *shrink()*, which shrinks a pedigree
