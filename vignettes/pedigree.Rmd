...
pedAll <- pedigree(
  id = sampleped$id,
  dadid = sampleped$father, momid = sampleped$mother,
  sex = sampleped$sex, famid = sampleped$ped
)
print(pedAll)
``` 
...
```{r, datped2}
datped2 <- sampleped[sampleped$ped %in% 2, ]
...
pedAll <- with(sampleped, pedigree(
  id = id, dadid = father, momid = mother,
