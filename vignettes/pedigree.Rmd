...
- The [alignment algorithm]("alignment_details.html") used create the Pedigree structure `vignette("Pedigree alignment details", package = "Pedixplorer")`
...
- hints: a list of 2 elements indicating the horder and the spouse to
