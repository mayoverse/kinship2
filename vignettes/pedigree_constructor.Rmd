...
- **ped_df** A dataframe containing the columns
    ...
    1 = dead.
    - $family$ Optional, a numeric or character vector of family
    identifiers.
...
- **hints** Optional, a list containing the order in which to plot the
...
right way. If a $family$ column is present in the dataframe, then it will
...
- $scales$ a list of two elements
    - $fill$ a dataframe describing which modalities in which columns correspond
    to an affected individuals.
