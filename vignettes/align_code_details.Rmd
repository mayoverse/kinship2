...
has column 1 = subject plotted on the left, 2 = subject plotted on the right.
...
structure below.  When the second sib is processed they
will come back as a 1 element tree (the marriage will no longer
be on the spouselist), which should \emph{not} be added
onto rval. The rule thus is to not add any 1 element tree whose
...
(When initializing the output structures donot  worry about this - there
