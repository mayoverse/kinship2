...
The [[auto_hint]] routine is used to create an initial hints list. It is a part of
...
\begin{itemize}
  ...
  \item Call align to see how this works out
...
\begin{description}
    ...
    \item a hints object.  This is normally blank and auto_hint
      is invoked. 
\end{description}
