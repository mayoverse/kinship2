test_that("Class ped work", {
    ...
    ped3b <- suppressWarnings(c(ped3, ped3))
    ped5 <- suppressWarnings(c(ped3, ped2))

    expect_equal(ped3b, ped3)
...
test_that("Rel class works", {
    ...
    expect_equal(length(as.list(rel2)), 4)
    expect_equal(dim(as.data.frame(rel2)), c(2, 4))
